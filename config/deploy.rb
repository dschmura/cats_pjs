  ...
  set :application,     "cats_pjs"
  set :repo_url,        "git@github.com:dschmura/cats_pjs.git"
  set :user,            'deployer'
  ...
  set :deploy_to,       "/home/#{fetch(:user)}/apps/cats_pjs"
  # Puma specific settings
  set :puma_bind,       "unix://#{shared_path}/tmp/sockets/cats_pjs-puma.sock"
